...
```{r pepaverage, dependson = "PEP", echo = FALSE, fig.cap = "Relationship of the shrunken batting average and the posterior error probability of whether the player's batting average is greater than .3. The value .300 is marked as a dashed red line."}
career_eb %>%
