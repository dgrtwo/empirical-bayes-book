...
In any case, we certainly can't fit a simple linear trend here. To capture the nonlinear trend, we could instead fit a [natural cubic spline](https://en.wikipedia.org/wiki/Spline_interpolation) using the [ns function](http://www.inside-r.org/r-doc/splines/ns):[^df]
